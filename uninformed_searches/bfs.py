...
def bfs_search(start_state, goal_state, dumpflag):
    """
    Breadth-first search algorithm to find the shortest path from start_state to goal_state.
...
result = bfs_search(start_state, goal_state, False)
print(result)
